package com.eCommerce.EcommerceBackend.userPreference.model;
...
public class Address {
    ...
    @NotBlank
    @Size(min = 5, message = "Bulidng name must be atleast 5 character")
    ...
    @NotBlank
    @Size(min = 6, message = "Zipcode name must be atleast 6 character")
